...
export default function About({ children }: AboutProps) {
  return (
    <motion.div
      className="bg-primary-foreground/50 shadow-aboutcard relative flex h-full min-h-[400px] w-full max-w-[785px] auto-rows-[176px] grid-cols-4 flex-col gap-4 rounded-xl p-4 backdrop-blur-sm md:grid"
      initial={{
        opacity: 0,
